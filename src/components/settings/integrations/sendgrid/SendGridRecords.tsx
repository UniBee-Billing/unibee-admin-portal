import { ArrowLeftOutlined, CheckOutlined, CloseOutlined, FilterOutlined, MailOutlined, PercentageOutlined, SearchOutlined } from '@ant-design/icons'
...
const SendGridRecords = () => {
  ...
  const fetchEmailHistory = async (page = pagination.current, pageSize = pagination.pageSize) => {
    ...
    const statusMap: { [key: string]: number[] } = {
      sent: [1],
      failed: [2, 0], // pending is also considered as failed
    };
  ...
  const successRate = (() => {
    ...
    // Truncate to 1 decimal to avoid rounding up to 100.0 when close to 100
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="p-6">
        {/* Page Title */}
        <h1 className="text-2xl font-semibold mb-6">SendGrid Email Records</h1>
...
export default SendGridRecords
